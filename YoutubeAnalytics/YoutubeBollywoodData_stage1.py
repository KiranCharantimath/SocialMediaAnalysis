...
r = requests.get("https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UC3MLnJtqc_phABBriLRhtgQ&order=date&publishedAfter=2018-4-26T21:50:00Z&key=AIzaSyBZGs_NULQpduDZlaseKfLwSBpS5RInsow&maxResults=50")
...
while(i<6):
	...
	r = requests.get("https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UC3MLnJtqc_phABBriLRhtgQ&order=date&publishedAfter=2018-4-26T21:50:00Z&key=AIzaSyBZGs_NULQpduDZlaseKfLwSBpS5RInsow&maxResults=50"+"&pageToken="+str(nextToken))
